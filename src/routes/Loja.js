...
const pratosInfo = [
  {
    ...
    preco: 'R$ 14,00',
    link: '/loja/rolinhoPrimavera' // Link para a página do Rolinho Primavera - MODIFICADO!
  },
  {
    nome: 'Ceviche',
    imagem: img2,
    ...
    preco: 'R$ 30,00',
    link: '/loja/ceviche' // Link para a página do Ceviche
  },
  {
    nome: 'Guioza',
    imagem: img3,
    ...
    preco: 'R$ 16,00',
    link: '/loja/guioza' // Link para a página do Guioza
  },
  {
    nome: 'Hot Roll',
    imagem: img4,
    ...
    preco: 'R$ 20,00',
    link: '/loja/hotRoll' // Link para a página do Hot Roll
  },
  {
    nome: 'Kare',
    imagem: img5,
    ...
    preco: 'R$ 35,00',
    link: '/loja/kare' // Link para a página do Kare
  },
  {
    nome: 'Lamen',
    imagem: img6,
    ...
    preco: 'R$ 28,00',
    link: '/loja/lamen' // Link para a página do Lamen
  },
  {
    nome: 'Missoshiru',
    imagem: img7,
    ...
    preco: 'R$ 12,00',
    link: '/loja/missoshiru' // Link para a página do Missoshiru
  },
  {
    ...
    preco: 'R$ 5,50',
    link: '/loja/niguiriCamarao' // Link para a página do Niguiri de Camarão
  },
  {
    nome: 'Salmão',
    imagem: img9,
    ...
    preco: 'R$ 9,50',
    link: '/loja/salmao' // Link para a página do Salmão
  },
  {
    ...
    preco: 'R$ 6,00',
    link: '/loja/sashimiPeixeBranco' // Link para a página do Sashimi de Peixe Branco
  },
  {
    nome: 'Shimeji',
    imagem: img11,
    ...
    preco: 'R$ 12,00',
    link: '/loja/Shimeji' // Link para a página do Shimeji
  },
  {
    nome: 'Sunomono',
    imagem: img12,
    ...
    preco: 'R$ 13,50',
    link: '/loja/Sunomomo' // Link para a página do Sunomono
  },
  {
