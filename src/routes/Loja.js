...
const pratosInfo = [
  { nome: 'Rolinho Primavera de Queijo', imagem: img1, descricao: 'Rolinho Primavera de Queijo', preco:'R$ 14,00'},
  { nome: 'Ceviche', imagem: img2, descricao: 'Ceviche', preco:'R$: 30,00'},
  { nome: 'Guioza', imagem: img3, descricao: 'Guioza', preco:'R$ 16,00; '},
  { nome: 'Hot Roll', imagem: img4, descricao: 'Hot Roll', preco:'R$20.00; '},
  { nome: 'Kare', imagem: img5, descricao: 'Kare', preco:'R$; '},
  { nome: 'Lamen', imagem: img6, descricao: 'Lamen', preco:'R$; '},
  { nome: 'Missoshiru', imagem: img7, descricao: 'Missoshiru', preco:'R$; '},
  { nome: 'Niguiri de Camarão', imagem: img8, descricao: 'Niguiri de Camarão', preco:'R$; '},
  { nome: 'Salmão', imagem: img9, descricao: 'Salmão', preco:'R$; '},
  { nome: 'Sashimi de Peixe Branco', imagem: img10, descricao: 'Sashimi de Peixe Branco', preco:'R$; '},
  { nome: 'Shimeji', imagem: img11, descricao: 'Shimeji', preco:'R$; '},
  { nome: 'Sunomono', imagem: img12, descricao: 'Sunomono', preco:'R$; '},
  { nome: 'Temaki de Salmão', imagem: img13, descricao: 'Temaki de Salmão', preco:'R$; '},
  { nome: 'Tempura', imagem: img14, descricao: 'Tempura', preco:'R$; '},
  { nome: 'Yakisoba', imagem: img15, descricao: 'Yakisoba', preco:'R$; '},
  { nome: 'Yakisoba de Frutos do Mar', imagem: img16, descricao: 'Yakisoba de Frutos do Mar', preco:'R$; '},
];
